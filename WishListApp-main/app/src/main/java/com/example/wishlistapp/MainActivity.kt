            ...
            MaterialTheme {
                Surface {
                    ...
                    NavHost(
                        ...
                        composable(Screen.CATEGORY_SCREEN_NEW.route) {
                            CategoryScreen(viewModel, navController)
                        }
                        composable(
                            Screen.EDIT_CATEGORY_SCREEN.route,
